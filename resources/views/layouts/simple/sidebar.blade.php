<div class="sidebar-wrapper" sidebar-layout="stroke-svg">
    <div>
        <div class="logo-wrapper">
            <a href="">
                <img class="img-fluid for-light" src="{{ asset('assets/images/ikankakap/logo/logo-text.png') }}" alt="">
                <img class="img-fluid for-dark" src="{{ asset('assets/images/ikankakap/logo/logo-text.png') }}" alt="">
            </a>
        ...
        <div class="logo-icon-wrapper">
            <a href="">
                <img class="img-fluid" src="{{ asset('assets/images/ikankakap/logo/logo.png') }}" alt=""
        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn">
                        <a href="">
                            <img class="img-fluid" src="{{ asset('assets/images/ikankakap/logo/logo-text.png') }}"
                                alt="">
                        </a>
                                        ...
                                        <div class="link-section">
                                            ...
                                            <ul class="submenu-content opensubmegamenu">
                                                ...
                                                <li><a href="{{ route('sign-up') }}" target="_blank">Register
                                                        Simple</a></li>
                                                <li><a href="{{ route('sign-up-one') }}" target="_blank">Register with
                                                        Bg Image
                                                    </a></li>
                                                <li><a href="{{ route('sign-up-two') }}" target="_blank">Register with
                                                        image
                                                        two</a></li>
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="{{ route('knowledgebase') }}">
                            <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                            class="sidebar-link sidebar-title link-nav" href="{{ route('support-ticket') }}">
                            <svg class="stroke-icon">
