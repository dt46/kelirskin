            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a href="' + data + '" data-lightbox="gambar" data-title="Foto KTP"><button class="btn btn-primary btn-sm">Unduh</button></a>';
                    }
                },
                {
                    data: 'no_hp'
                ...
                },
                {
                    data: null,
                    render: function (data, type, row) {
                        return '<button class="btn btn-danger btn-sm tolak" disabled>Tolak</button>&nbsp;<button class="btn btn-success btn-sm terima" disabled>Terima</button>';
                    },
                    className: 'text-center'
                },
            ],
