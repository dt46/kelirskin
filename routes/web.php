...
Route::prefix('forms')->group(function () {
    ...
    Route::view('profile', 'forms.profile')->name('profile-agen');
...
Route::prefix('tables')->group(function () {
    Route::view('kedatangan', 'tables.kedatangan')->name('kedatangan');
    Route::view('keberangkatan', 'tables.keberangkatan')->name('keberangkatan');
